...
import { Position, Health, blueprint } from '@mud/prefabs';
import type { ComponentDataTuple } from '@mud/ecs-engine';
import { Name, Description, Retaliate, Wander, Aggressive, Pose, Loot, Stats } from './traits';
...
function wolfBlueprint(roomId: EntityId, _seq: number) {
  const components: ComponentDataTuple[] = [
