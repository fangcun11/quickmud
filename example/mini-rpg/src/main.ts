...
/**
 * mini-rpg 终端 REPL（v0.7-B）
 *
 * 输入处理采用「队列 + 串行排水」模式（与 demo-adventure 同款）：
...
async function main() {
  ...
  console.log('=== 蛛巢悬赏 · mini-rpg（MUD 文字游戏引擎 v' + ENGINE_VERSION + '） ===');
  console.log('村庄的村长挂了赏格。输入 help 查看命令，输入 quit 退出。');
  console.log('');
